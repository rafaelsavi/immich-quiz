...
export const TRANSLATIONS = {
  EN: {
    ...
    "mode.album_shuffle_desc": "Match 5 photos to map pins & order chronologically.",
    "mode.pinpoint_settings_title": "Pinpoint Settings (Guessing mode)",
    "mode.album_shuffle_settings_title": "Album Shuffle Settings",
    "setup.guess_mode": "Guessing mode",
  ...
  PT: {
    ...
    "mode.album_shuffle_desc": "Associe 5 fotos aos pinos do mapa e ordene-as cronologicamente.",
    "mode.pinpoint_settings_title": "Configurações do Mira Certa (Modo de Adivinhação)",
    "mode.album_shuffle_settings_title": "Configurações do Álbum Embaralhado",
