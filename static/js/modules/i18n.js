...
export const TRANSLATIONS = {
  EN: {
    ...
    "setup.libraries_selected": (count) => `${count} libraries selected`,
    ...
    "setup.sync_title_with_date": (dateStr) => `Sync metadata from Immich\nLast sync: ${dateStr}`,
    ...
    "summary.meta_rounds": (rounds) => `${rounds} Rounds`,
    "summary.meta_library": (library) => `Library: ${library}`,
    "summary.meta_filter": (filter) => `Filter: ${filter}`,
    "summary.meta_filters": (filters) => `Filters: ${filters}`,
  ...
  PT: {
    ...
    "setup.all_libraries": "-",
    "setup.library_search_placeholder": "Buscar bibliotecas...",
    "setup.no_libraries_found": "Nenhuma biblioteca encontrada",
    "setup.libraries_selected": (count) => `${count} bibliotecas selecionadas`,
    ...
    "setup.sync_title_with_date": (dateStr) => `Sincronizar metadados do Immich\nÚltima sincronização: ${dateStr}`,
    ...
    "summary.meta_rounds": (rounds) => `${rounds} Rodadas`,
    "summary.meta_library": (library) => `Biblioteca: ${library}`,
    "summary.meta_filter": (filter) => `Filtro: ${filter}`,
    "summary.meta_filters": (filters) => `Filtros: ${filters}`,
    "summary.meta": (rounds, modes, library, album) =>
