...
export const TRANSLATIONS = {
  EN: {
    ...
    "mode.album_shuffle.goal_location_desc": "Match the 3 photos to existing map pins",
    ...
    "setup.sync_indexing": "Indexing...",
    "setup.sync_indexed_count": (count) => `${count.toLocaleString()} indexed`,
    ...
    "setup.include_partner_photos": "Include partner photos",
    "setup.include_shared_albums": "Include shared albums",
  ...
  PT: {
    ...
    "mode.album_shuffle.goal_location_desc": "Ligue as 3 fotos aos pinos existentes no mapa",
    ...
    "setup.sync_indexing": "Indexando...",
    "setup.sync_indexed_count": (count) => `${count.toLocaleString()} indexadas`,
    ...
    "setup.include_partner_photos": "Incluir fotos de parceiro(a)",
    "setup.include_shared_albums": "Incluir álbuns compartilhados",
