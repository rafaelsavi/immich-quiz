...
- **Round Length**: Set a turn timer: **30s**, **1 min**, **2 min**, **5 min**, or **Unlimited**. Timers feature silky-smooth 60 FPS drains, adaptive `M:SS` formatting (e.g. `2:00` → `1:15` → `59s` → `5s`), 3-tier visual tension states (teal → amber → crimson pulse), and audio ticks on final seconds.
